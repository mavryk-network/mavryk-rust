...
use mavryk_api::ffi::{
    ...
    MavrykRuntimeConfiguration, MavrykStorageInitError, ValidateOperationError,
...
use mavryk_context_api::{
    ...
    MavrykContextStorageConfiguration,
};
...
pub enum ProtocolMessage {
    ...
    ChangeRuntimeConfigurationCall(MavrykRuntimeConfiguration),
    InitProtocolContextCall(InitProtocolContextParams),
    InitProtocolContextIpcServer(MavrykContextStorageConfiguration),
...
pub enum NodeMessage {
    ...
    InitProtocolContextResult(Result<InitProtocolContextResult, MavrykStorageInitError>),

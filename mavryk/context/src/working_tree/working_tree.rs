...
use mavryk_timing::SerializeStats;
...
//*            .unwrap();
//*        let commit = storage
//*            .commit(0, "Mavryk".to_string(), "Genesis".to_string())
//*            .unwrap();
...
//*            .unwrap();
//*
//*        let commit = storage.commit(0, "Mavryk".to_string(), "Genesis".to_string());
//*
...
//*            .unwrap();
//*        let commit = storage.commit(0, "Mavryk".to_string(), "".to_string());
//*
...
//*        );
//*
//*        let _commit = storage.commit(0, "Mavryk".to_string(), "Genesis".to_string());
//*
//*        storage
//*            .set(
//*                1,

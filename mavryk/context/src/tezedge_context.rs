...
//! This module implements the Mavryk context API.
...
use mavryk_context_api::StringDirectoryMap;
use mavryk_timing::{BlockMemoryUsage, ContextMemoryUsage};
...
mod tests {
    ...
    #[test]
    fn init_context() {
        let context = initialize_tezedge_context(&MavrykContextTezEdgeStorageConfiguration {

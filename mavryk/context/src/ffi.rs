...
use mavryk_conv::{
    ...
    OCamlMavrykContextTezEdgeStorageConfiguration,
};
...
ocaml_export! {
    ...
    fn tezedge_index_init(
        rt,
        configuration: OCamlRef<OCamlMavrykContextTezEdgeStorageConfiguration>,
        ...
        let configuration: MavrykContextTezEdgeStorageConfiguration = configuration.to_rust(rt);

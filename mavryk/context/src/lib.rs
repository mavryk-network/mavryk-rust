...
//! TezEdge implementation of the context API and storage for the Mavryk economic protocol
//!
//! ```no_compile
//!                                                +----------+
//!                                                |  Commit  |
...
//!
//! In the Mavryk economic protocol, the context is represented as a tree, similar to a file system.
//!
...
use mavryk_context_api::{ContextKey, ContextKeyOwned, ContextValue, StringTreeObject};
use thiserror::Error;
...
use mavryk_timing::ContextMemoryUsage;

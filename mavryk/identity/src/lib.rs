...
/// This node identity information compatible with Mavryk
...
/// Load identity from mavryk configuration file.
...
mod tests {
    ...
    #[test]
    fn test_identity_json_serde_generated_by_mavryk() -> Result<(), anyhow::Error> {

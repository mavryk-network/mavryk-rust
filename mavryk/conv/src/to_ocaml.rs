...
use crate::{
    ...
    OCamlMavrykContextConfiguration, OCamlMavrykContextIrminStorageConfiguration,
    OCamlMavrykContextStorageConfiguration, OCamlMavrykContextTezedgeOnDiskBackendOptions,
    OCamlMavrykRuntimeConfiguration, OCamlMavrykRuntimeLogLevel, OCamlValidateOperationRequest,
};
...
use super::{
    ...
    OCamlRpcMethod, OCamlMavrykContextTezEdgeStorageConfiguration, TaggedHash,
};
use crypto::hash::{
...
impl_to_ocaml_record! {
    MavrykContextIrminStorageConfiguration => OCamlMavrykContextIrminStorageConfiguration {
        data_dir: String,
    }
}

impl_to_ocaml_record! {
    MavrykContextTezedgeOnDiskBackendOptions => OCamlMavrykContextTezedgeOnDiskBackendOptions {
        base_path: String,
        startup_check: bool,
    }
}
...
impl_to_ocaml_record! {
    MavrykContextTezEdgeStorageConfiguration => OCamlMavrykContextTezEdgeStorageConfiguration {
...
impl_to_ocaml_variant! {
    MavrykContextStorageConfiguration => OCamlMavrykContextStorageConfiguration {
        MavrykContextStorageConfiguration::IrminOnly(cfg: OCamlMavrykContextIrminStorageConfiguration),
        MavrykContextStorageConfiguration::TezEdgeOnly(cfg: OCamlMavrykContextTezEdgeStorageConfiguration),
        MavrykContextStorageConfiguration::Both(
            irmin: OCamlMavrykContextIrminStorageConfiguration,
            tezedge: OCamlMavrykContextTezEdgeStorageConfiguration,
        )
    }
}

impl_to_ocaml_record! {
    MavrykContextConfiguration => OCamlMavrykContextConfiguration {
        storage: OCamlMavrykContextStorageConfiguration,
...
impl_to_ocaml_variant! {
    MavrykRuntimeLogLevel => OCamlMavrykRuntimeLogLevel {
        MavrykRuntimeLogLevel::App,
        MavrykRuntimeLogLevel::Error,
        MavrykRuntimeLogLevel::Warning,
        MavrykRuntimeLogLevel::Info,
        MavrykRuntimeLogLevel::Debug,
    }
}

impl_to_ocaml_record! {
    MavrykRuntimeConfiguration => OCamlMavrykRuntimeConfiguration {
        log_enabled: bool,
        log_level: Option<OCamlMavrykRuntimeLogLevel>,
    }
}
...
impl_to_ocaml_polymorphic_variant! {
    ProtocolMessage => OCamlProtocolMessage {
        ...
        ProtocolMessage::ChangeRuntimeConfigurationCall(cfg: OCamlMavrykRuntimeConfiguration),
        ProtocolMessage::InitProtocolContextCall(params: OCamlInitProtocolContextParams),
        ProtocolMessage::InitProtocolContextIpcServer(cfg: OCamlMavrykContextStorageConfiguration),

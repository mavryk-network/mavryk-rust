...
/// OCaml refs:
///
/// [lib_p2p/p2p_message.ml:37](https://gitlab.com/tezedge/mavryk/-/blob/9aac95765dc8290ce2f722b7bd71042ff9609f46/src/lib_p2p/p2p_message.ml#L37)
/// ```ocaml
...
///
/// OCaml refs:
/// mavryk/src/lib_p2p/p2p_message.ml:64 (comment)
///
/// lib_base/p2p_point.ml:127
/// [lib_base/p2p_point.ml#L127](https://gitlab.com/tezedge/mavryk/-/blob/736f733f661877b5868f96d5c878f3f4a0486cb6/src/lib_base/p2p_point.ml#L127)
/// ```ocaml
///   let encoding =
///   let open Data_encoding in
///    check_size
...
///
/// OCaml refs:
/// [lib_p2p/p2p_socket.ml:252](https://gitlab.com/tezedge/mavryk/-/blob/8166ed7ad215544be69241df99af95deebeaeee3/src/lib_p2p/p2p_socket.ml#L252)
/// ```ocaml
///     let nack_encoding =
///      obj2
...
///
/// OCaml ref: mavryk/src/lib_shell/distributed_db_message.ml:65,
/// `operation_max_pass`
///
/// ```ocaml
...
///
/// OCaml ref: mavryk/src/lib_p2p/p2p_message.ml:64
/// ```ocaml
...
///
/// OCaml ref: mavryk/src/lib_p2p/p2p_connect_handler.ml
/// ```ocaml
...
/// [lib_shell/distributed_db_message.ml:32](https://gitlab.com/tezedge/mavryk/-/blob/922212530bf3442ab5535072ee95c406a0203816/src/lib_shell/distributed_db_message.ml#L32)
///
/// ```ocaml
...
/// OCaml refs:
/// `max_locator_size` in
/// [lib_shell/state.ml:1801](https://gitlab.com/mavryk/mavryk/-/blob/latest-release/src/lib_shell/state.ml#L1801)
///
/// ```ocaml
...
///
/// OCaml refs:
/// [lib_shell/distributed_db_message.ml:30](https://gitlab.com/tezedge/mavryk/-/blob/922212530bf3442ab5535072ee95c406a0203816/src/lib_shell/distributed_db_message.ml#L30)
...
/// Operation max size
///
/// OCaml ref: mavryk/src/lib_shell/distributed_db_message.ml:59,
/// `operation_max_size`
///
/// ```ocaml
...
/// Protocol max size
///
/// OCaml ref: mavryk/src/lib_shell/distributed_db_message.ml:122,
/// `protocol_max_size`
///
/// ```ocaml
...
/// [lib_shell/distributed_db_message.ml:142](https://gitlab.com/tezedge/mavryk/-/blob/3c6f7c0126472693cd2cd5208e5301aae9283dde/src/lib_shell/distributed_db_message.ml#L142)
/// ```ocaml
...
/// OCaml refs:
///
/// [lib_base/mempool.ml:44](https://gitlab.com/tezedge/mavryk/-/blob/3c6f7c0126472693cd2cd5208e5301aae9283dde/src/lib_base/mempool.ml#L44)
/// ```ocaml
...
///
/// OCaml ref: mavryk/src/lib_shell/distributed_db_message.ml:217,
///
/// ```ocaml
...
///
/// OCaml ref: mavryk/src/lib_shell/distributed_db_message.ml:230,
///
/// ```ocaml
...
///
/// OCaml ref: mavryk/src/lib_shell/distributed_db_message.ml:242,
///
/// ```ocaml
...
///
/// OCaml ref: mavryk/src/lib_shell/distributed_db_message.ml:258,
///
/// ```ocaml
///      (obj1
///         (req
...
///
/// OCaml ref: mavryk/src/lib_shell/distributed_db_message.ml:61,
...
/// Maximal lenght for Mavryk chain name.
///
/// Currently the longest one is the `MAVRYK_ALPHANET_CARTHAGE_2019-11-28T13:02:13Z`.

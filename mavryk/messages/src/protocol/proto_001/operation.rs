...
//! See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#alpha-operation-alpha-contents-determined-from-data-8-bit-tag].

use crypto::hash::{
    BlockHash, ContextHash, ContractKt1Hash, ContractMv1Hash, HashTrait, OperationListListHash,
    ProtocolHash, Signature,
};
use mavryk_encoding::binary_reader::BinaryReaderError;
use mavryk_encoding::types::{Mumav, SizedBytes};
...
/// Operation contents.
/// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#operation-alpha-specific].
...
/// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#endorsement-tag-0].
...
/// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#alpha-inlined-endorsement-contents-5-bytes-8-bit-tag].
#[cfg_attr(feature = "fuzzing", derive(fuzzcheck::DefaultMutator))]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, HasEncoding, NomReader, BinWriter)]
...
/// Inlined endorsement.
/// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#alpha-inlined-endorsement].
#[cfg_attr(feature = "fuzzing", derive(fuzzcheck::DefaultMutator))]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, HasEncoding, NomReader, BinWriter)]
...
pub enum Contents {
    /// Endorsmnent (tag 0).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#id5].
    Endorsement(EndorsementOperation),

    /// Seed_nonce_revelation (tag 1).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#seed-nonce-revelation-tag-1].
    SeedNonceRevelation(SeedNonceRevelationOperation),

    /// Double_endorsement_evidence (tag 2).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#double-endorsement-evidence-tag-2].
    DoubleEndorsementEvidence(DoubleEndorsementEvidenceOperation),

    /// Double_baking_evidence (tag 3).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#double-baking-evidence-tag-3].
    DoubleBakingEvidence(DoubleBakingEvidenceOperation),

    /// Activate_account (tag 4).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#activate-account-tag-4].
    ActivateAccount(ActivateAccountOperation),

    /// Proposals (tag 5).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#proposals-tag-5].
    Proposals(ProposalsOperation),

    /// Ballot (tag 6).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#ballot-tag-6].
    Ballot(BallotOperation),

    /// Reveal (tag 107).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#reveal-tag-107].
    #[encoding(tag = 107)]
    Reveal(RevealOperation),
    /// Transaction (tag 108).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#transaction-tag-108].
    #[encoding(tag = 108)]
    Transaction(TransactionOperation),
    /// Origination (tag 109).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#origination-tag-109].
    #[encoding(tag = 109)]
    Origination(OriginationOperation),
    /// Delegation (tag 110).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#delegation-tag-110].
    #[encoding(tag = 110)]
...
/// X_0.
/// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#x-0.
#[cfg_attr(feature = "fuzzing", derive(fuzzcheck::DefaultMutator))]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, HasEncoding, NomReader, BinWriter)]
pub struct X0 {
...
/// alpha.entrypoint.
/// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#alpha-entrypoint-determined-from-data-8-bit-tag.
#[cfg_attr(feature = "fuzzing", derive(fuzzcheck::DefaultMutator))]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, HasEncoding, NomReader, BinWriter)]
pub enum Entrypoint {
    /// default (tag 0).
    /// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#default-tag-0.
    Default,

    /// root (tag 1).
    /// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#root-tag-1.
    Root,

    /// do (tag 2).
    /// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#do-tag-2.
    Do,

    /// set_delegate (tag 3).
    /// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#set-delegate-tag-3.
    SetDelegate,

    /// remove_delegate (tag 4).
    /// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#remove-delegate-tag-4.
    RemoveDelegate,

    /// named (tag 255).
    /// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#named-tag-255.
    #[encoding(tag = 255)]
...
/// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#alpha-scripted-contracts.
#[cfg_attr(feature = "fuzzing", derive(fuzzcheck::DefaultMutator))]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, HasEncoding, NomReader, BinWriter)]
...
/// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#alpha-contract-id-22-bytes-8-bit-tag.
#[cfg_attr(feature = "fuzzing", derive(fuzzcheck::DefaultMutator))]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, HasEncoding, NomReader, BinWriter)]
#[serde(untagged)]
pub enum ContractId {
    /// Implicit (tag 0).
    /// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#implicit-tag-0.
    Implicit(SignaturePublicKeyHash),

    /// Originated (tag 1).
    /// See https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#originated-tag-1.
    ...
    operation_contents_test!(activate_account, contents, {
        match &contents[0] {
            Contents::ActivateAccount(ActivateAccountOperation { pkh, secret }) => {
                assert_eq!(
                    pkh.to_base58_check(),
                    "mv1DrL6KF8g2a3Adj49uuNtkxTUE5JKxzFHX"
                );
                assert_eq!(
                    hex::encode(&secret),
        ...
        match &contents[0] {
            Contents::Origination(OriginationOperation {
                ...
                assert_eq!(
                    ...
                    Some("mv18Cw7psUrAAPBpXYd9CtCpHg9EgjHP9KTe".to_string())
                );
            }

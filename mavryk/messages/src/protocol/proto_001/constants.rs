...
pub struct ParametricConstants {
    ...
    tokens_per_roll: Option<Mumav>,
    michelson_maximum_type_size: Option<u16>,
    seed_nonce_revelation_tip: Option<Mumav>,
    origination_burn: Option<Mumav>,
    #[get = "pub"]
    block_security_deposit: Option<Mumav>,
    #[get = "pub"]
    endorsement_security_deposit: Option<Mumav>,
    #[get = "pub"]
    block_reward: Option<Mumav>,
    #[get = "pub"]
    endorsement_reward: Option<Mumav>,
    cost_per_byte: Option<Mumav>,

...
//! See http://protocol.mavryk.org/protocols/011_hangzhou.html#global-constants.
...
pub enum Contents {
    ...
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#endorsement-with-slot-tag-10].
    #[encoding(tag = 10)]
    #[serde(rename = "endorsement_with_slot")]
    EndorsementWithSlot(EndorsementWithSlotOperation),

    /// Failing_noop (tag 17).
    /// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#failing-noop-tag-17].
    #[encoding(tag = 17)]
...
/// See [https://protocol.mavryk.org/shell/p2p_api.html?highlight=p2p%20encodings#register-global-constant-tag-111].
#[cfg_attr(feature = "fuzzing", derive(fuzzcheck::DefaultMutator))]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, HasEncoding, NomReader, BinWriter)]

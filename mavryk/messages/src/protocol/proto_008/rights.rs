...
mod tests {
    ...
    #[test]
    fn test_endorsing_right_with_mv1_to_json() -> Result<(), Error> {
        let er = EndorsingRight::new(
            296772,
            SignaturePublicKeyHash::from_b58_hash("mv1KcPCMjPAu5hs1C9jpHMBm69KudcrBpksw")?,
            vec![27, 16, 14, 13, 0],
            Some(1585207011),
        );

        let json = er.as_map();
        let expected_json = json!({"level":296772,"delegate":"mv1KcPCMjPAu5hs1C9jpHMBm69KudcrBpksw","slots":[27,16,14,13,0],"estimated_time":"2020-03-26T07:16:51Z"});

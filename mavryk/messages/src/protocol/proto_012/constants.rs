...
pub struct ParametricConstants {
    ...
    tokens_per_roll: Mumav,
    michelson_maximum_type_size: u16,
    seed_nonce_revelation_tip: Mumav,
    origination_size: i32,
    block_security_deposit: Mumav,
    endorsement_security_deposit: Mumav,
    #[encoding(dynamic, list)]
    baking_reward_per_endorsement: Vec<Mumav>,
    #[encoding(dynamic, list)]
    endorsement_reward: Vec<Mumav>,
    cost_per_byte: Mumav,
    ...
    double_baking_punishment: Mumav,

...
//! This crate provides definitions of mavryk messages.
use getset::Getters;
...
impl BinWriter for Timestamp {
    fn bin_write(&self, output: &mut Vec<u8>) -> mavryk_encoding::enc::BinResult {
        mavryk_encoding::enc::i64(&self.0, output)
    }
}

...
use mavryk_messages::base::rpc_support::{RpcJsonMap, UniversalValue};
...
pub struct MavrykContextIrminStorageConfiguration {
    pub data_dir: String,
}

// Must be in sync with ffi_config.ml
#[derive(Clone, Serialize, Deserialize, Debug)]
pub struct MavrykContextTezedgeOnDiskBackendOptions {
...
pub enum ContextKvStoreConfiguration {
    ReadOnlyIpc,
    InMem(MavrykContextTezedgeOnDiskBackendOptions),
    OnDisk(MavrykContextTezedgeOnDiskBackendOptions),
}

// Must be in sync with ffi_config.ml
#[derive(Clone, Serialize, Deserialize, Debug)]
pub struct MavrykContextTezEdgeStorageConfiguration {
...
// Must be in sync with ffi_config.ml
#[derive(Clone, Serialize, Deserialize, Debug)]
pub enum MavrykContextStorageConfiguration {
    IrminOnly(MavrykContextIrminStorageConfiguration),
    TezEdgeOnly(MavrykContextTezEdgeStorageConfiguration),
    Both(
...
impl MavrykContextStorageConfiguration {
    ...
    pub fn readonly(&self) -> Self {
        match self {
            MavrykContextStorageConfiguration::IrminOnly(_) => self.clone(),
            MavrykContextStorageConfiguration::TezEdgeOnly(tezedge) => {
            ...
            MavrykContextStorageConfiguration::Both(_irmin, tezedge) => {
                MavrykContextStorageConfiguration::TezEdgeOnly(
                    MavrykContextTezEdgeStorageConfiguration {
                        backend: ContextKvStoreConfiguration::ReadOnlyIpc,
                        ..tezedge.clone()
    ...
    pub fn with_path(&self, data_dir: String) -> Self {
        ...
        match self {
            MavrykContextStorageConfiguration::IrminOnly(_) => {
                MavrykContextStorageConfiguration::IrminOnly(MavrykContextIrminStorageConfiguration {
                    data_dir,
                })
            }
            MavrykContextStorageConfiguration::TezEdgeOnly(_) => {
                MavrykContextStorageConfiguration::TezEdgeOnly(
                    MavrykContextTezEdgeStorageConfiguration {
            ...
            MavrykContextStorageConfiguration::Both(_irmin, _tezedge) => self.clone(),
        }
    }

    pub fn get_ipc_socket_path(&self) -> Option<String> {
        match self {
            MavrykContextStorageConfiguration::IrminOnly(_) => None,
            MavrykContextStorageConfiguration::TezEdgeOnly(tezedge) => {
    ...
    pub fn tezedge_is_enabled(&self) -> bool {
        match self {
            MavrykContextStorageConfiguration::IrminOnly(_) => false,
            MavrykContextStorageConfiguration::TezEdgeOnly(_) => true,
            MavrykContextStorageConfiguration::Both(_, _) => true,
        }
    }
}
...
pub struct MavrykContextConfiguration {
    pub storage: MavrykContextStorageConfiguration,

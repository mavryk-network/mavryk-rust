...
use mavryk_messages::p2p::binary_message::{MessageHash, MessageHashError};
...
pub enum MavrykRuntimeLogLevel {
    App,
    Error,
    Warning,
    Info,
...
#[derive(Serialize, Deserialize, Debug, Clone)]
pub struct MavrykRuntimeConfiguration {
    pub log_enabled: bool,
    pub log_level: Option<MavrykRuntimeLogLevel>,
}
...
impl From<MavrykErrorTrace> for GetLastContextHashesError {
    fn from(error: MavrykErrorTrace) -> Self {
...
#[cfg(feature = "fuzzing")]
use mavryk_encoding::fuzzing::bigint::BigIntMutator;
...
/// Represents a trace of errors produced by Mavryk.
///
...
impl From<MavrykErrorTrace> for CallError {
    fn from(error: MavrykErrorTrace) -> Self {
...
#[cfg_attr(feature = "fuzzing", derive(fuzzcheck::DefaultMutator))]
#[derive(Error, Serialize, Deserialize, Debug, Clone)]
pub enum MavrykStorageInitError {
    #[error("OCaml storage init failed, message: {message}!")]
    InitializeError { message: String },
}

impl From<MavrykErrorTrace> for MavrykStorageInitError {
    fn from(error: MavrykErrorTrace) -> Self {
...
impl From<FromBytesError> for MavrykStorageInitError {
...
impl From<MavrykErrorTrace> for GetDataError {
    fn from(error: MavrykErrorTrace) -> Self {
...
impl From<MavrykErrorTrace> for DumpContextError {
    fn from(error: MavrykErrorTrace) -> Self {
...
impl From<MavrykErrorTrace> for RestoreContextError {
    fn from(error: MavrykErrorTrace) -> Self {
...
impl From<MavrykErrorTrace> for IntegrityCheckContextError {
    fn from(error: MavrykErrorTrace) -> Self {
        Self::IntegrityError {
            message: error.trace_json,
        }
...
impl From<MavrykErrorTrace> for ContextDataError {
    fn from(error: MavrykErrorTrace) -> Self {
...
impl From<MavrykErrorTrace> for ProtocolDataError {
    fn from(error: MavrykErrorTrace) -> Self {
...
impl From<MavrykErrorTrace> for FfiJsonEncoderError {
    fn from(error: MavrykErrorTrace) -> Self {
...
/// Error types generated by a mavryk protocol.
#[cfg_attr(feature = "fuzzing", derive(fuzzcheck::DefaultMutator))]
#[derive(Error, Serialize, Deserialize, Debug, Clone)]
pub enum ProtocolError {
    ...
    /// OCaml part failed to initialize mavryk storage.
    #[error("OCaml storage init error: {reason}")]
    OcamlStorageInitError { reason: MavrykStorageInitError },
...
mod tests {
    ...
    use mavryk_context_api::ProtocolOverrides;

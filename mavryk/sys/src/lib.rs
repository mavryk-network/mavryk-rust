...
//! Bindings to tezedge FFI functions in libmavryk.so.
...
/// This function does nothing. It exists to force cargo to link libmavryk to crates
/// that depend on mavryk-sys.
////
/// To do so, define a `pub` function in the crate that requires libmavryk linking that
/// calls this function.
///
...
/// What is done with this function is to add a call from the crates that require libmavryk to be linked

...
fn test_chain_id_roundtrip(iteration: i32) -> Result<(), anyhow::Error> {
    ...
    let result = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        let result = mavryk_ffi::chain_id_roundtrip(rt, &chain_id).to_rust(rt);
...
fn test_block_header_roundtrip(iteration: i32) -> Result<(), anyhow::Error> {
    ...
    let result = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        let result = mavryk_ffi::block_header_roundtrip(rt, &header).to_rust(rt);
...
fn test_block_header_struct_roundtrip(iteration: i32) -> Result<(), anyhow::Error> {
    ...
    let result = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        let (block_hash, chain_id) =
            mavryk_ffi::block_header_struct_roundtrip(rt, &header).to_rust::<(String, String)>(rt);
...
fn test_block_header_with_hash_roundtrip(iteration: i32) -> Result<(), anyhow::Error> {
    ...
    let result = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        let result = mavryk_ffi::block_header_with_hash_roundtrip(rt, &header_hash, &header)
...
fn test_operation_roundtrip(iteration: i32) -> Result<(), anyhow::Error> {
    ...
    let result = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        let result = mavryk_ffi::operation_roundtrip(rt, &operation).to_rust::<String>(rt);
...
fn test_operations_list_list_roundtrip(
    ...
    let result = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        // sent bytes to ocaml
        let result = mavryk_ffi::operations_list_list_roundtrip(rt, &operations_list_list_ocaml);

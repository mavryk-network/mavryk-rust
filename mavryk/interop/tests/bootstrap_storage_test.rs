...
use mavryk_api::ffi::{ApplyBlockError, ApplyBlockRequest, BeginApplicationRequest};
...
fn test_bootstrap_empty_storage_with_first_three_blocks() {
    ...
    let (chain_id, genesis_block_header, ..) =
        init_test_protocol_context("bootstrap_test_storage_01", test_data::mavryk_network());
...
fn test_bootstrap_empty_storage_with_first_block_twice() {
    ...
    // init empty context for test
    let (chain_id, genesis_block_header, ..) =
        init_test_protocol_context("bootstrap_test_storage_09", test_data::mavryk_network());
...
fn test_bootstrap_empty_storage_with_first_two_blocks_and_check_result_json_metadata() {
    ...
    let (chain_id, genesis_block_header, genesis_additional_data, result) =
        init_test_protocol_context("bootstrap_test_storage_10", test_data::mavryk_network());
...
fn test_bootstrap_empty_storage_with_second_block_with_first_predecessor_should_fail_unknown_predecessor_context(
    ...
    // init empty context for test
    let (chain_id, ..) =
        init_test_protocol_context("bootstrap_test_storage_02", test_data::mavryk_network());
...
fn test_bootstrap_empty_storage_with_third_block_with_first_predecessor_should_fail_predecessor_mismatch(
    ...
    // init empty context for test
    let (chain_id, ..) =
        init_test_protocol_context("bootstrap_test_storage_18", test_data::mavryk_network());
...
fn test_bootstrap_empty_storage_with_second_block_should_fail_incomplete_operations() {
    ...
    // init empty context for test
    let (chain_id, genesis_block_header, ..) =
        init_test_protocol_context("bootstrap_test_storage_03", test_data::mavryk_network());
...
fn test_bootstrap_empty_storage_with_first_block_with_invalid_operations_should_fail_invalid_operations(
    ...
    // init empty context for test
    let (chain_id, genesis_block_header, ..) =
        init_test_protocol_context("bootstrap_test_storage_04", test_data::mavryk_network());
...
mod test_data {
    ...
    pub const MAVRYK_NETWORK: MavrykEnvironment = MavrykEnvironment::Alphanet;

    pub fn mavryk_network() -> MavrykEnvironmentConfiguration {
        mavryk_api::environment::default_networks()
            .get(&MAVRYK_NETWORK)

...
fn test_hash_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_hash(rt, &operation_hash, &hash_bytes).to_rust(rt)
    })
    .unwrap();
...
fn test_block_header_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_block_header(
            rt,
            &block_header,
            &level,
            &proto_level,
...
fn test_apply_block_request_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_apply_block_request(
            rt,
            &apply_block_request,
            &chain_id,
            &block_header,
...
fn test_cycle_rolls_owner_snapshot_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_cycle_rolls_owner_snapshot(
            rt,
...
fn test_apply_block_response_conv() {
    ...
    let (into, from): (bool, bool) = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        let into_result: bool = mavryk_ffi::construct_and_compare_apply_block_response(
            rt,
...
fn test_begin_construction_request_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_begin_construction_request(
            rt,
...
fn test_validate_operation_request_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_validate_operation_request(
            rt,
...
fn test_validate_rpc_request_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_rpc_request(
            rt,
            &rpc_request,
            &body,
            &context_path,
...
fn test_validate_protocol_rpc_request_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_protocol_rpc_request(
            rt,
...
fn test_validate_operation_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_operation(rt, &operation, &branch, &proto).to_rust(rt)
    })
    .unwrap();
...
fn test_validate_prevalidator_wrapper_conv() {
    ...
    let result: bool = runtime::execute(move |rt: &mut OCamlRuntime| {
        ...
        mavryk_ffi::construct_and_compare_prevalidator_wrapper(
            rt,

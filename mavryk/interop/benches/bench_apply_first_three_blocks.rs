...
use mavryk_api::environment::{
    default_networks, get_empty_operation_list_list_hash, MavrykEnvironmentConfiguration,
};
use mavryk_api::ffi::{ApplyBlockRequest, InitProtocolContextResult, MavrykRuntimeConfiguration};
...
mod test_data {
    ...
    use mavryk_api::environment::MavrykEnvironment;
    use mavryk_messages::p2p::binary_message::BinaryRead;

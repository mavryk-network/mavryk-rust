// Copyright (c) SimpleStaking, Viable Systems, Trili Tech, Nomadic Labs and Tezedge Contributors
...
pub use mavryk_encoding_derive::HasEncoding;
...
hash_has_encoding!(Layer2Mv4Hash, LAYER2_MV4HASH);
